...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/core-hr.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Mar 2023 08:00:24 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
											...
											<li>
												<div class="timeline-panel">
													<div class="media me-2">
														<img alt="image" width="50" src="theme/images/avatar/1.jpg">
													</div>
									...
									<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
										<div class="header-info2 d-flex align-items-center">
											<div class="header-media">
												<img src="theme/images/tab/1.jpg" alt="">
											</div>
									...
									<div class="dropdown-menu dropdown-menu-end" style="">
										<div class="card border-0 mb-0">
											<div class="card-header py-2">
												<div class="products">
													<img src="theme/images/tab/1.jpg" class="avatar avatar-md" alt="">
													<div>
														<h6>Thomas Fleming</h6>
											...
											<table id="empoloyees-tbl" class="table">
												...
												<tbody>
													<tr>
														...
														<td>
															<div class="products">
																<img src="theme/images/contacts/pic2.jpg" class="avatar avatar-md" alt="">
																<div>
																	<h6>Moni Antony</h6>
																	<span>Web Designer</span>	
																</div>	
													...
													<tr>
														...
														<td>
															<div class="products">
																<img src="theme/images/contacts/pic1.jpg" class="avatar avatar-md" alt="">
																<div>
																	<h6>Joney Antony</h6>
																	<span>Web Designer</span>	
																</div>	
													...
													<tr>
														...
														<td>
															<div class="products">
																<img src="theme/images/contacts/pic3.jpg" class="avatar avatar-md" alt="">
																<div>
																	<h6>Peter Oliver</h6>
																	<span>Web Designer</span>	
																</div>	
    ...
    ***********************************-->
	...
	<script src="theme/js/bootstrap-select.min.js"></script>
	 <!-- clockpicker -->
    <script src="theme/js/bootstrap-clockpicker.min.js"></script>
	
	<script src="theme/js/apexchart.js"></script>
	
	 <!-- Clockpicker init -->
    <script src="theme/js/clock-picker-init.js"></script>
	
	<!-- tagify -->
	<script src="theme/js/tagify.js"></script>
	
	<!-- Dashboard 1 -->
	<script src="theme/js/core-hr.js"></script>
...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/core-hr.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Mar 2023 08:00:25 GMT -->
</html>